...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " chobber-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  chobber-tx [options] <hex-tx> [commands]  Update hex-encoded chobber transaction\n" +
            "or:     chobber-tx [options] -create [commands]   Create hex-encoded chobber transaction\n" +
            "\n";
