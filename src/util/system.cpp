...
const char * const BITCOIN_CONF_FILENAME = "chobber.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Chobber";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Chobber";
#else
    // Unix-like
    return pathRet / ".chobber";
#endif
#endif
}
